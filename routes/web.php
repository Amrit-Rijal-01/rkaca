...
Route::get('/industryDetails/{slug}', [FrontIndustryController::class, 'show'])->name('industryDetails');
Route::get('/serviceDetails/{slug}', [FrontServiceController::class, 'show'])->name('serviceDetails');
