                        ...
                        <div class="col-md-4">
                            <div class="card bg-light">
                                <div class="card-body">
                                    ...
                                    <div class="mb-3 form-check">
                                        <input type="checkbox" class="form-check-input" id="is_sub_service" name="is_sub_service" value="1" {{ old('is_sub_service', $service->is_sub_service) ? 'checked' : '' }}>
                                        <label class="form-check-label" for="is_sub_service">Is Sub-Service</label>
                                    </div>

                                    <div class="mb-3" id="parentServiceWrapper" style="display: {{ old('is_sub_service', $service->is_sub_service) ? 'block' : 'none' }};">
                                        <label for="parent_id" class="form-label">Parent Service <span class="text-danger">*</span></label>
                                        <select class="form-select @error('parent_id') is-invalid @enderror" id="parent_id" name="parent_id" {{ old('is_sub_service', $service->is_sub_service) ? 'required' : '' }}>
