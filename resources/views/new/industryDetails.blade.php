        ...
        <main>
                ...
                <div class="sd-body-inner">
                    ...
                    <div class="sd-content-card gsap-animate">
                        <div class="section-label">
                            <i class="fas fa-file-alt"></i> Industry Details
                        </div>
            ...
            <section class="sd-bottom-cta">
                <div class="sd-bottom-cta-inner gsap-animate">
                    ...
                    <p>Contact us today to learn how <strong>{{ $industry->title ?: $industry->name }}</strong> can drive your success.</p>
                    <div class="sd-hero-actions">
                        <a href="/contact" class="btn-primary-filled">
                            Contact Us <i class="fas fa-arrow-right"></i>
                        </a>
                        <a href="/industries" class="btn-primary-outline">
                            Explore All Industries <i class="fas fa-arrow-right"></i>
                        </a>
                    </div>
                </div>
            </section>
